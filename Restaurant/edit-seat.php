            ...
            <div class="container-fluid mt-3">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $get_table_id = $_GET['table'];

                        $get_table_data = "SELECT * FROM my_table where table_id = $get_table_id";
                        $execute = $conn->query($get_table_data);
                        ...
                        <form method="post" action="edit-seat-2.php">


                            <div class="form-group">

                                <input type="hidden" name="table_id" value="<?php echo $fetch_data->table_id ?>">

                                <label>Table No.</label>
                                <input type="text" name="table_no" value="<?php echo $fetch_data->table_no ?>"
